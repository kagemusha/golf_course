...
class AmenitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amenity" do
    assert_difference("Amenity.count") do
      post amenities_url, params: { amenity: { concurrent: @amenity.concurrent, length: @amenity.length, name: @amenity.name, width: @amenity.width } }
    end
  ...
  test "should update amenity" do
    patch amenity_url(@amenity), params: { amenity: { concurrent: @amenity.concurrent, length: @amenity.length, name: @amenity.name, width: @amenity.width } }
